        ...
        <div class="admin_login_add">
            <ul>
                ...
                <li class="font_color1">
                    ...
                    - <input type="text" name="adm_tel2" class="add_input1 hp2" placeholder="1234" maxlength="4">
                    - <input type="text" name="adm_tel3" class="add_input1 hp2" placeholder="5678" maxlength="4">
                </li>
                <li class="font_color1">관리자 담당부서 및 직책</li>
                <li>
                    <select name="adm_dp" class="add_select1">
                    ...
                    <select name="adm_pos" class="add_select1">
                ...
                <li class="font_color1">
                    ※ 가입완료 후 전산 담당자가 확인 후 로그인 할 수 있습니다.
                </li>
            </ul>
            <span class="admin_addbtn">
                <input type="button" class="btn_button btncolor1" title="관리자 등록" onclick="admin_add()" value="관리자 등록">
                <input type="button" class="btn_button btncolor2" title="관리자 취소" onclick="addmin_cancel()" value="등록 취소">
            </span>
        </div>
    </section>
	</form>
